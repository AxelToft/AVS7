...
class train_learn:
    ...
    def computing_accuracy(self, distances, thresholds, trn_path, val_path):  # compute accuracy for each parameter
        ...
        for distance in distances:  # for each distance
            ...
            for threshold in thresholds:  # for each threshold
                ...
                self.training_export(distance, threshold, accuracy_trn, accuracy_val,wrong_videos_trn)  # export accuracy for each parameter
    ...
    def training_export(self, distance, threshold, accuracy_trn, accuracy_val,wrong_videos):  # export accuracy
        with open('accuracies_training', 'a') as f:  # open file
            f.write(f"{distance};{threshold};{accuracy_trn};{accuracy_val};{wrong_videos}\n")  # write accuracy
